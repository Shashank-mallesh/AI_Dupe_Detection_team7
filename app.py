...
def identify_brand_and_authenticity(image):
    ...
    # Use image properties to generate consistent but varied results
    seed_value = int(features["brightness"] + features["contrast"]) % 1000
    ...
    quality_score = (
        ...
        min(features["sharpness"], 2.0) * 0.3 +
